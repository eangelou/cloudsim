...
import org.cloudbus.cloudsim.CloudletSchedulerDynamicWorkloadIopsRuleOfThumb;
 ...
 */
public class HelperIopsRuleOfThumb {
	...
	public static List<Vm> createVmList(int brokerId, int vmsNumber) {
		...
		for (int i = 0; i < vmsNumber; i++) {
			...
			vm = new PowerVm(
					...
					1,
					"Xen",
					new CloudletSchedulerDynamicWorkloadIopsRuleOfThumb(Constants.VM_IOPS, Constants.VM_MIPS[vmType], Constants.VM_PES[vmType]),
