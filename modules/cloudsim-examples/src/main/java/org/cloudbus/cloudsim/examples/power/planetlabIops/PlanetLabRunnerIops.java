 ...
 * @since Jan 5, 2012
 */
public class PlanetLabRunnerIops extends RunnerAbstract {
	...
	protected void init(String inputFolder) {
		try {
			...
			cloudletList = PlanetLabHelperIops.createCloudletListPlanetLab(brokerId, inputFolder);
