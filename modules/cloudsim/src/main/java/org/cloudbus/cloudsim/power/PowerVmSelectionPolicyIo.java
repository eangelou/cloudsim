 ...
 */
public abstract class PowerVmSelectionPolicyIo {
	 ...
	 */
	protected List<PowerVmIo> getMigratableVms(PowerHost host) {
		List<PowerVmIo> migratableVms = new ArrayList<PowerVmIo>();
		for (PowerVmIo vm : host.<PowerVmIo> getVmList()) {
			if (!vm.isInMigration()) {
