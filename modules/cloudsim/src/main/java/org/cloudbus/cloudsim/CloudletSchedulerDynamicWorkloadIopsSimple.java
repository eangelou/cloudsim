 ...
 */
public class CloudletSchedulerDynamicWorkloadIopsSimple extends CloudletSchedulerDynamicWorkloadIops {
	 ...
	 */
	public CloudletSchedulerDynamicWorkloadIopsSimple(double iops, double mips, int numberOfPes) {
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare, Double iopsShare) {
		double previousIopsShare = getCurrentIopsShare();
